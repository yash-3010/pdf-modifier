  ...
  return (
    <div className='h-screen w-full mx-auto max-w-[1366px] pt-32 px-2 md:px-10 lg:px-32 lg:pb-32 md:flex justify-between'>
      ...
      <div className='text-center my-5'>
        <img className='hidden md:block h-60 w-full' src="https://cdn.dribbble.com/users/285475/screenshots/2310943/media/9572e637ed414bd59027780928770c6c.gif" alt='okay' />
